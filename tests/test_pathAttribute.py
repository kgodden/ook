...
class TestPathAttribute(TestCase):
    ...
    def test_evaluate(self):
        ...
        self.assertEquals(values, ['ridge', 'sync_test', 'camera1', 'structured_light', '0000', '2015-10-27T13-26-52-302857', '9'])
        ...
        values = attribute.evaluate(path2)
        self.assertEquals(values, ['ridge', 'sync_test', 'camera1', 'structured_light', '0000', '1445952412.302857', '9'])
